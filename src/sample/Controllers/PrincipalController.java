...
public  class PrincipalController {
    ...
    @FXML public void  clicLista(ActionEvent event){
        try {
            alista=FXMLLoader.load(getClass().getResource("../FXML/tpacientes.fxml"));
        }catch (IOException e){
            e.printStackTrace();
        }
    ...
    @FXML public void  clicFiltro(ActionEvent event){
        try {
            afiltro=FXMLLoader.load(getClass().getResource("../FXML/buscar.fxml"));
        }catch (IOException e){
            e.printStackTrace();
        }

        panel.getChildren().setAll(afiltro);

    }
    @FXML public void  clicCsv(ActionEvent event){
        try {
            acsv=FXMLLoader.load(getClass().getResource("../FXML/csv.fxml"));
        }catch (IOException e){
            e.printStackTrace();
        }

        panel.getChildren().setAll(acsv);
